...
<head>
<meta charset="utf-8"/>
<title>Metronic | Flotchart</title>
				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Basic Chart</span>
							</div>
							<div class="tools">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Tracking Curves</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Dynamic Chart</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Stack Chart Controls</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Horizontal Bar Chart</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Default</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph1</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph2</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph3</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph5</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph6</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph7</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph8</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph9</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph10</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Graph11</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
