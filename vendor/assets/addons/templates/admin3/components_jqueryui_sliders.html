...
<head>
<meta charset="utf-8"/>
<title>Metronic | jQuery UI Sliders</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>jQuery UI Sliders <small>jquery ui sliders</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="components_jqueryui_sliders.html">UI Components</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Sliders</span>
							</div>
							<div class="tools">
							...
							<form role="form" class="form-horizontal form-bordered">
								<div class="form-body">
									...
									<div class="form-group last">
										<label class="col-md-3 control-label">Range(Vertical)</label>
										<div class="col-md-4">
											<div class="slider-vertical-value">
