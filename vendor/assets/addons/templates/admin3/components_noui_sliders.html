...
<head>
<meta charset="utf-8"/>
<title>Metronic | NoUI Range Sliders</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>NoUI Range Sliders <small>super tiny jQuery plugin that allows you to create range sliders</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="components_noui_sliders.html">UI Components</a>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="note note-success note-bordered">
						<p>
							 To modify the slider size and colors, please go to <code>assets/css/plugins.css</code> and refer the code under <code>NoUI Range Sliders</code> code comment.
						</p>
					</div>
					<!-- BEGIN PORTLET-->
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">NoUI Range Sliders</span>
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<form role="form" class="form-horizontal form-bordered">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Basic Range Slider</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Attach To Inputs</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="noUi-control noUi-warning" id="slider_3">
											</div>
											<label class="margin-top-10">
											<input id="slider_3_checkbox" type="checkbox" value="1"> Disable! </label>
										</div>
									</div>
									<div class="form-group last">
										<label class="col-md-3 control-label">Reading Slider Value</label>
										<div class="col-md-4">
											<div class="noUi-control noUi-default" id="slider_4">
											</div>
											<a id="slider_4_btn" href="javascript:;" class="margin-top-10 btn blue btn-sm">
											Read me! </a>
										</div>
									</div>
								</div>
