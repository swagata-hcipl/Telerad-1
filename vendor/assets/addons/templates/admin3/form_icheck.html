...
<head>
<meta charset="utf-8"/>
<title>Metronic | iCheck Controls</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>iCheck Controls <small>icheck controls</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="form_icheck.html">UI Components</a>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="note note-bordered note-danger">
						<p>
							 ...
							 via HTML attributes <code>data-checkbox="icheckbox-minimal-grey"</code> or <code>data-radio="iradio-flat-grey"</code> and Metronic will take care of the plugin initialization.
						</p>
						<p>
