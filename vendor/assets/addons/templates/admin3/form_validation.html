	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="form_validation.html">UI Components</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Validation Basicss</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="javascript:;" id="form_sample_1" class="form-horizontal">
								<div class="form-body">
				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Validation Using Icons</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
