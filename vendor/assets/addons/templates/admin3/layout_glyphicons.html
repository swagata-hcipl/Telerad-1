...
<head>
<meta charset="utf-8"/>
<title>Metronic | Layout with Glyphicon</title>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						...
						<ul class="dropdown-menu dropdown-menu-default">
							...
							<li>
								<a href="inbox.html">
								<i class="glyphicon glyphicon-envelope"></i> My Inbox <span class="badge badge-danger">
								3 </span>
								</a>
							</li>
							<li>
								<a href="javascript:;">
								<i class="glyphicon glyphicon-cloud"></i> My Tasks <span class="badge badge-success">
								7 </span>
								</a>
							</li>
							<li class="divider">
							...
							<li>
								...
								<i class="glyphicon glyphicon-lock"></i> Lock Screen </a>
							</li>
							<li>
								<a href="login.html">
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Layout with Glyphicon <small>glyphicon samples</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
					...
					<div class="portlet light ">
						<div class="portlet-title">
							<div class="caption caption-md">
								...
								<span class="caption-subject theme-font bold uppercase">Simple Table</span>
							</div>
							<div class="actions">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="portlet light ">
						<div class="portlet-title">
							<div class="caption caption-md">
								<i class="icon-bar-chart theme-font hide"></i>
								<span class="caption-subject theme-font bold uppercase">Bordered Table</span>
							</div>
							<div class="actions">
								<a class="btn btn-circle btn-icon-only btn-default" href="javascript:;">
								<i class="glyphicon glyphicon-cloud"></i>
