	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Ajax Portlets <small>ajax portlet samples</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="portlet_ajax.html">Extra</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="portlet_ajax.html">Portlets</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 Ajax Portlets
			...
			<div class="note note-info note-bordered">
				...
				<p>
					 Remove <code>data-load=&quot;true&quot;</code> to prevent the initial loading of the content so the content will be loaded only upon clicking on the reload icon.
				</p>
			</div>
			<div class="row">
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Scrollable Content</span>
							</div>
							<div class="tools">
								...
								<a href="javascript:;" data-load="true" data-url="portlet_ajax_content_1.html" class="reload">
								</a>
				...
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Advance Form</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
								...
								<a href="javascript:;" data-load="true" data-url="portlet_ajax_content_2.html" class="reload">
								</a>
								<a href="javascript:;" class="remove">
								</a>
							</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Load On Demand
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
								...
								<a href="javascript:;" data-url="portlet_ajax_content_3.html" class="reload">
								</a>
								<a href="javascript:;" class="remove">
								</a>
							</div>
						...
						<div class="portlet-body portlet-empty">
							 Defualt content goes here. Click the reload icon above to reload the content from ajax source.
						</div>
					</div>
					<!-- END Portlet PORTLET-->
				</div>
				<div class="col-md-6">
					<!-- BEGIN Portlet PORTLET-->
					<div class="portlet solid green-haze" id="my_portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Custom Reload Handler
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Error Message On Reload Using Notific8</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
								...
								<a href="javascript:;" data-error-display="notific8" data-url="portlet_ajax_content_error.html" class="reload">
								</a>
								<a href="javascript:;" class="remove">
								</a>
							</div>
						...
						<div class="portlet-body portlet-empty">
							 Try to reload the content to see how the error message is displayed.
						</div>
					</div>
					<!-- END Portlet PORTLET-->
				</div>
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Error Message On Reload using Toastr</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
								...
								<a href="javascript:;" data-error-display="toastr" data-url="portlet_ajax_content_error.html" class="reload">
								</a>
								<a href="javascript:;" class="remove">
								</a>
							</div>
