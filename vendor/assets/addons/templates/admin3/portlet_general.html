...
<head>
<meta charset="utf-8"/>
<title>Metronic | General Portlets</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>General Portlets <small>general portlet samples</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="portlet_general.html">Extra</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="portlet_general.html">Portlets</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 General Portlets
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box red-sunglo">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Nestable Portlets
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
			...
			<div class="row">
				...
				<div class="col-md-3 ">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Collapsed
							</div>
							<div class="tools">
