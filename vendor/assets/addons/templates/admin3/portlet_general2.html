...
<head>
<meta charset="utf-8"/>
<title>Metronic | New Portlets #1</title>
...
<body class="page-boxed page-header-fixed page-container-bg-solid page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed-hide-logo">
<!-- BEGIN HEADER -->
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>New Portlets #1 <small>general portlet samples</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="portlet_general2.html">Extra</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="portlet_general2.html">Portlets</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 New Portlets #1
			...
			<div class="note note-info note-bordered">
				<p>
					 See <a href="ui_colors.html" target="_blank">
					ui_colors.html </a>
					for more colors for portlets.
				</p>
			</div>
			<div class="row">
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-blue-hoki">
								Pagination </span>
							</div>
