...
<head>
<meta charset="utf-8"/>
<title>Metronic | New Portlets #2</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>New Portlets #2 <small>general portlet samples</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="portlet_general3.html">Extra</a>
					<i class="fa fa-circle"></i>
				</li>
				<li>
					<a href="portlet_general3.html">Portlets</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 New Portlets #2
