...
<head>
<meta charset="utf-8"/>
<title>Metronic | Alerts & Dialogs API</title>
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_alert_dialog_api.html">UI Components</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Bootbox Demo</span>
							</div>
							<div class="tools">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Metronic's API for Bootstrap Alerts</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
