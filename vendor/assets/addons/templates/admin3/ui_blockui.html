	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_blockui.html">UI Components</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Portlet Blocking</span>
							</div>
							<div class="tools">
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Page Blocking</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Element Blocking</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Custom Messages</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
