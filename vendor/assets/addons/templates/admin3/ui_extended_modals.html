...
<head>
<meta charset="utf-8"/>
<title>Metronic | Extended Modals</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Extended Modals <small>extended bootstrap modals</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_extended_modals.html">UI Components</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Extended Modals Example</span>
							</div>
							<div class="tools">
