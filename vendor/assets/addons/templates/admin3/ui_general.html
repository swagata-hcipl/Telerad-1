	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_general.html">UI Components</a>
				...
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Inline Notifications</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Pulsate</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Modal Dialogs</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							<p>
								 Tight pants next level keffiyeh <a href="javascript:;" class="tooltips" data-original-title="Very long toolips Very long toolips Very long toolips Very long toolips">
								you probably </a>
								haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="javascript:;" class="tooltips" data-original-title="Another tooltip">
								have a </a>
								terry richardson vinyl chambray. <a href="javascript:;" class="tooltips" title="12" data-original-title="The last tip!">
								twitter handle </a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Tooltips In Slim Scroll</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
						...
						<div class="portlet-body">
							<div class="scroller" style="height:150px" data-always-visible="1" data-rail-visible="0">
								...
								<p>
									 Tight pants next level keffiyeh <a href="javascript:;" class="tooltips" data-container="body" data-original-title="Default tooltip">
									you probably </a>
									haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="javascript:;" class="tooltips" data-container="body" data-original-title="Another tooltip">
									have a </a>
									terry richardson vinyl chambray. <a href="javascript:;" class="tooltips" title="12" data-container="body" data-original-title="The last tip!">
									twitter handle </a>
									freegan cred raw denim single-origin coffee viral.
								</p>
								<button class="btn tooltips" data-container="body" data-placement="top" data-original-title="Tooltip in top">Top</button>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Popovers</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Popovers In Slim Scroll</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Panels</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
				...
				<div class="col-md-6">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Progress Bars</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Labels & Badges</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Pagination</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Dynamic Pagination(jQuery Bootpag)</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Wells</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">Media Objects</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
