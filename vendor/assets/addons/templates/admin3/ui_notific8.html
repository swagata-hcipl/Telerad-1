...
<head>
<meta charset="utf-8"/>
<title>Metronic | Notific8 Notifications</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Notific8 Notifications <small>Windows 8 style notifications</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_notific8.html">UI Components</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Notific8 Notification Demo</span>
							</div>
							<div class="tools">
