...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Progress Bar</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Page Progress Bar <small>an automatic web page progress bar</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_page_progress_style_1.html">UI Components</a>
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Pace Themes</span>
							</div>
							<div class="tools">
