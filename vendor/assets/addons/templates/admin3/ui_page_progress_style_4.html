...
<head>
<meta charset="utf-8"/>
<title>Metronic | Page Progress Bar - Style 4</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Page Progress Bar - Style 4 <small>an automatic web page progress bar</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_page_progress_style_4.html">UI Components</a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 Page Progress Bar - Style 4
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<tr class="active">
								...
								<td>
									<a class="btn blue" href="ui_page_progress_style_4.html">
									View Demo </a>
								</td>
							</tr>
							</table>
