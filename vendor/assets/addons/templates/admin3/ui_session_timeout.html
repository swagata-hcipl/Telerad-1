...
<head>
<meta charset="utf-8"/>
<title>Metronic | Session Timeout</title>
	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Session Timeout <small>user session timeout control</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
	...
	<div class="page-content">
		<div class="container">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="ui_session_timeout.html">UI Components</a>
